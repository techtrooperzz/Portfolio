...
export const BookingModal: React.FC<BookingModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    ...
    >
      ...
      {/* Modal Container */}
      <div 
        className={`relative bg-brand-surface border border-brand-border w-full rounded-2xl z-10 text-left transform transition-all duration-300 shadow-2xl flex flex-col overflow-hidden ${
          step === 'CALENDAR' 
                  ...
                  {daysArray.map((day, index) => {
                    ...
                    return (
                      <button
                        ...
                        className={`relative aspect-square flex flex-col items-center justify-center text-[12px] font-medium rounded-lg transition-all duration-150 border cursor-pointer ${
                          past 
                ...
                <div className="flex items-center bg-white/5 border border-white/10 p-0.5 rounded-lg shrink-0">
                  <button
                    ...
                    className={`text-[8px] font-bold font-mono px-1.5 py-0.5 rounded transition-all ${
                      !is24h ? 'bg-white text-black' : 'text-slate-400 hover:text-white'
                    }`}
                  >
                    12h
                  </button>
                  ...
                  return (
                    <div key={slot} className="flex gap-1 transition-all duration-200">
                      <button
                        ...
                        className={`grow text-center text-xs font-mono font-medium py-2 border rounded-lg transition-all duration-150 cursor-pointer ${
                          isCurrentActive
            ...
            <form onSubmit={handleSubmit} className="space-y-3">
              ...
              <div>
                ...
                <textarea 
                  ...
                  placeholder="Tell us briefly about your system goals, visual concepts, etc." 
                  rows={2} 
