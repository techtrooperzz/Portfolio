...
export const faqs = [
        {
            ...
            answer: 'The cost depends on the type of website, features, design complexity, and custom requirements. After understanding your goals, we provide a transparent proposal with estimated timelines and pricing.',
        },
        {
            question: 'How long does it take to develop a website?',
            answer: 'The timeline depends on the project\'s scope. A basic website can be completed within a few weeks, while larger platforms with custom features may require more time. We always define clear milestones before starting development.',
        },
        {
            question: 'Will my website work on mobile devices?',
            answer: 'Yes. Every website we develop is designed to be responsive, ensuring a smooth experience across smartphones, tablets, and desktop devices.',
        },
        {
            question: 'Do you provide support after website launch?',
            answer: 'Yes, we provide website maintenance and support services to ensure your website remains secure, updated, and running smoothly after launch. Maintenance services are available as a separate paid plan based on your requirements, including updates, improvements, troubleshooting, and technical assistance.',
        },
        {
        ...
        },
        {
            ...
            answer: 'We follow a flexible installment-based payment structure to ensure a smooth project workflow. Typically, payments are divided into multiple milestones — an initial payment at the start of the project, a second installment during the development phase, and the final payment upon project completion and approval before final delivery. The exact payment schedule may vary depending on the project scope and requirements.',
        },
    ];