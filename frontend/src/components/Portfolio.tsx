    ...
    const caseStudies = [
        {
            ...
            image: '../assets/images/ficmh-logo.jpg',
        ...
        },
        {
            ...
            image: '../assets/images/Gokhale-logo.jpg',
            fallback: 'https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?q=80&w=1200&auto=format&fit=crop',
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
                    ...
                    {caseStudies.map((item, idx) => (
                        <a
                            ...
                            className="group relative overflow-hidden bg-brand-surface aspect-square border border-brand-border/45 cursor-pointer rounded-xl block shadow-xl shadow-black/25"
                        >
                            <img
                                referrerPolicy="no-referrer"
                                src={item.image}
                                alt={item.title}
                                className="grayscale-img absolute inset-0 w-full h-full object-cover transition-all group-hover:scale-105 duration-500 grayscale-0"
                                loading="lazy"
                                onError={(e) => {
