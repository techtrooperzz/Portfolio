    ...
    return (
        <section id="testimonials" className="py-12 sm:py-16 bg-brand-dark">
            <div className="max-w-[1200px] mx-auto px-6 sm:px-12">
                ...
                {/* Dynamic 2-Column Testimonial Cards */}
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-20">
                    {testimonialsData.map((testimonial) => (
                        <div
                            key={testimonial.id}
                            className="bg-brand-surface border border-brand-border rounded-2xl p-8 flex flex-col justify-between space-y-8"
                        >
                            ...
                            <div className="flex items-center justify-between border-t border-brand-border-subtle pt-6">
                                <div className="flex items-center space-x-3.5">
                                    <img
                                        ...
                                        alt={`${testimonial.name} close-up avatar portrait`}
                                        className="w-12 h-12 rounded-full object-cover grayscale"
                                        loading="lazy"
                                    />
                                    <div>
                                        <h4 className="text-sm font-bold text-white font-sans">{testimonial.name}</h4>
                                ...
                                <div className="text-right">
                                    <div className="text-xs text-[#facc15] font-sans font-bold flex items-center justify-end space-x-1">
                                        ...
                                        <span className="tracking-widest">{renderStars(testimonial.rating)}</span>
                                    </div>
